...
export enum Permission {
  ...
  COUNSELLOR_WRITE = 'counsellor:write',
...
export const ROLE_PERMISSIONS: Record<UserRole, Permission[]> = {
  ...
  [UserRole.ADMIN]: [
    ...
    Permission.ENQUIRY_WRITE,
    Permission.ENQUIRY_DELETE,
    Permission.ENQUIRY_IMPORT,
    Permission.ENQUIRY_EXPORT,
    ...
    Permission.COUNSELLOR_READ,
    Permission.COUNSELLOR_WRITE,
    Permission.COUNSELLOR_DELETE,
