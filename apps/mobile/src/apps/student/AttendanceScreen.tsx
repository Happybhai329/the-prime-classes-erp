...
export const AttendanceScreen = () => {
  ...
  const { data: attendanceReport, isLoading } = useQuery({
    queryKey: ['studentAttendanceReport', studentId],
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={styles.header}>
        <Text style={[styles.title, { color: colors.text }]}>ATTENDANCE RECORDS</Text>
      </View>
      ...
      <View style={styles.overviewGrid}>
        ...
        <View style={[styles.statBox, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          ...
          <Text style={[styles.statLbl, { color: colors.textMuted }]}>DUTY RATE</Text>
        </View>
      </View>
        ...
        ListEmptyComponent={
          !isLoading ? (
            <Text style={[styles.emptyText, { color: colors.textMuted }]}>
              NO ATTENDANCE SESSIONS LOGGED IN THE SYSTEM.
            </Text>
          ) : null
        }
        renderItem={({ item }: any) => (
